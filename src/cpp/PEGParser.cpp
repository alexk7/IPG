// This file was automatically generated by IPG on Thu Aug  4 16:13:39 2011
...
bool PEGParser::Parser::Parse(SymbolType _type, const char*& p)
{
	...
	switch (_type)
	{
		...
		{
			if (fail[SymbolType_LITERAL_2].count(pBegin))
				return false;
			EndMap::iterator i = end[SymbolType_LITERAL_2].find(pBegin);
			if (i != end[SymbolType_LITERAL_2].end())
			{
				p = i->second;
				return true;
			}
			...
			if (r)
				end[SymbolType_LITERAL_2][pBegin] = p;
			else
				fail[SymbolType_LITERAL_2].insert(pBegin);
			return r;
		}
		...
		{
			if (fail[SymbolType_Range_1].count(pBegin))
				return false;
			EndMap::iterator i = end[SymbolType_Range_1].find(pBegin);
			if (i != end[SymbolType_Range_1].end())
			{
				p = i->second;
				return true;
			}
			...
			if (r)
				end[SymbolType_Range_1][pBegin] = p;
			else
				fail[SymbolType_Range_1].insert(pBegin);
			return r;
		}
