...
bool PEGParser::Context::Parse_CLASS(const char*& p)
{
	bool r = true;
	char c;
	c = *p++;
...
bool PEGParser::Context::Parse_CLASS_1(const char*& p)
{
	bool r = true;
	char c;
	c = *p++;
...
bool PEGParser::Context::Parse_Char(const char*& p)
{
	bool r = true;
	char c;
	const char* b = p;
...
bool PEGParser::Context::Parse_Definition(const char*& p)
{
	bool r = true;
	char c;
...
bool PEGParser::Context::Parse_Expression(const char*& p)
{
	bool r = true;
	char c;
...
bool PEGParser::Context::Parse_Expression_1(const char*& p)
{
	bool r = true;
	char c;
	c = *p++;
...
bool PEGParser::Context::Parse_Grammar(const char*& p)
{
	bool r = true;
	char c;
...
bool PEGParser::Context::Parse_Grammar_1(const char*& p)
{
	bool r = true;
	char c;
	for (;;)
...
bool PEGParser::Context::Parse_IDENTIFIER_1(const char*& p)
{
	bool r = true;
	char c;
	for (;;)
...
bool PEGParser::Context::Parse_Identifier(const char*& p)
{
	bool r = true;
	char c;
	const char* b = p;
...
bool PEGParser::Context::Parse_Item(const char*& p)
{
	bool r = true;
	char c;
...
bool PEGParser::Context::Parse_Item_1(const char*& p)
{
	bool r = true;
	char c;
	const char* b = p;
...
bool PEGParser::Context::Parse_Item_2(const char*& p)
{
	bool r = true;
	char c;
	const char* b = p;
...
bool PEGParser::Context::Parse_LEFTARROW(const char*& p)
{
	bool r = true;
	char c;
	c = *p++;
...
bool PEGParser::Context::Parse_LITERAL(const char*& p)
{
	bool r = true;
	char c;
	const char* b = p;
...
bool PEGParser::Context::Parse_LITERAL_1(const char*& p)
{
	bool r = true;
	char c;
	for (;;)
...
bool PEGParser::Context::Parse_Primary(const char*& p)
{
	bool r = true;
	char c;
	const char* b = p;
...
bool PEGParser::Context::Parse_Primary_1(const char*& p)
{
	bool r = true;
	char c;
	c = *p++;
...
bool PEGParser::Context::Parse_Primary_2(const char*& p)
{
	bool r = true;
	char c;
	c = *p++;
...
bool PEGParser::Context::Parse_Primary_3(const char*& p)
{
	bool r = true;
	char c;
	c = *p++;
...
bool PEGParser::Context::Parse_Range(const char*& p)
{
	bool r = true;
	char c;
	r = Parse(SymbolType_Char, p);
...
bool PEGParser::Context::Parse_Sequence(const char*& p)
{
	bool r = true;
	char c;
	for (;;)
...
bool PEGParser::Context::Parse(SymbolType _type, const char*& p)
{
	const char* pBegin = p;
...
bool PEGParser::Context::Traverse(PEGParser::SymbolType _type, const char*& p, PEGParser::Symbols& v)
{
	const char* pBegin = p;
	bool r = true;
	char c;
...
void PEGParser::Context::Print(std::ostream& _os, PEGParser::SymbolType _type, const char* _pNode, int _tabs, int _maxLineSize)
{
	Symbols children;
...
bool PEGParser::Context::Visit(PEGParser::SymbolType _type, const char*& _p, PEGParser::Symbols& _v)
{
...
PEGParser::Iterator PEGParser::Parse(PEGParser::SymbolType _type, const char* _text)
{
...
const PEGParser::Symbol& PEGParser::Iterator::operator*() const
{
...
PEGParser::Iterator PEGParser::Iterator::GetChild() const
{
	if (mpSiblings)
	{
		Symbols children;
...
PEGParser::Iterator::Iterator(boost::shared_ptr<Context> _pParser, boost::shared_ptr<Symbols> _pSiblings)
: mpContext(_pParser)
