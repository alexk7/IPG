// This file was automatically generated by IPG on Wed Aug 31 22:24:08 2011
...
namespace
{
	...
	bool Traverse_AND(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_CLASS(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_CLASS_1(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_CLOSE(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_Char(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_Comment(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_DOT(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_Definition(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_EndOfFile(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_EndOfLine(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_Expression(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_Expression_1(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_Grammar(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_Grammar_1(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_IDENTIFIER(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_IDENTIFIER_1(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_Identifier(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_Item(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_Item_1(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_Item_2(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_LEFTARROW(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_LITERAL(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_LITERAL_1(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_NOT(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_OPEN(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_PLUS(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_Primary(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_Primary_1(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_Primary_2(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_Primary_3(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_QUESTION(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_Range(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_SLASH(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_STAR(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_Sequence(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_Space(Context& _ctx, const char*& p, vector<Symbol>& _v);
	bool Traverse_Spacing(Context& _ctx, const char*& p, vector<Symbol>& _v);
}
...
namespace
{
	...
	bool Parse_CLASS(Context& _ctx, const char*& p)
	{
		...
		if (r)
		{
			for (;;)
			{
				...
				if (r)
				{
					r = ParseText(_ctx, SymbolType_Range, p);
				}
				if (!r)
				{
					p = b;
			...
			if (r)
			{
				r = ParseText(_ctx, SymbolType_CLASS_1, p);
			}
		}
		return r;
	}
	...
	bool Parse_Definition(Context& _ctx, const char*& p)
	{
		...
		if (r)
		{
			r = ParseText(_ctx, SymbolType_LEFTARROW, p);
			if (r)
			{
				r = ParseText(_ctx, SymbolType_Expression, p);
			}
		}
		return r;
	}
	...
	{
		bool r = true;
		r = ParseText(_ctx, SymbolType_Sequence, p);
		if (r)
		{
			for (;;)
			{
				const char* b = p;
				r = ParseText(_ctx, SymbolType_Expression_1, p);
				if (r)
				{
					r = ParseText(_ctx, SymbolType_Sequence, p);
				}
	...
	{
		bool r = true;
		r = ParseText(_ctx, SymbolType_Grammar_1, p);
		if (r)
		{
			r = ParseText(_ctx, SymbolType_Definition, p);
			if (r)
			{
				for (;;)
				{
	...
	{
		bool r = true;
		r = ParseText(_ctx, SymbolType_Identifier, p);
		if (r)
		{
			r = ParseText(_ctx, SymbolType_IDENTIFIER_1, p);
		}
		return r;
	}
	...
	{
		bool r = true;
		r = ParseText(_ctx, SymbolType_Item_1, p);
		if (r)
		{
			r = ParseText(_ctx, SymbolType_Primary, p);
			if (r)
			{
				r = ParseText(_ctx, SymbolType_Item_2, p);
			}
		}
		return r;
	}
	...
	bool Parse_LITERAL(Context& _ctx, const char*& p)
	{
		...
		if (r)
		{
			for (;;)
			{
				...
				if (r)
				{
					r = ParseText(_ctx, SymbolType_Char, p);
				}
				if (!r)
				{
					p = b2;
		...
		if (r)
		{
			r = ParseText(_ctx, SymbolType_LITERAL_1, p);
		}
		return r;
	}
	...
	bool Parse_Primary(Context& _ctx, const char*& p)
	{
		...
		{
			p = b;
			r = ParseText(_ctx, SymbolType_Primary_1, p);
			if (r)
			{
				r = ParseText(_ctx, SymbolType_Expression, p);
				if (r)
				{
					r = ParseText(_ctx, SymbolType_Primary_2, p);
				}
			}
			if (!r)
			{
				p = b;
				r = ParseText(_ctx, SymbolType_LITERAL, p);
				if (!r)
				{
					p = b;
					r = ParseText(_ctx, SymbolType_CLASS, p);
					if (!r)
					{
						p = b;
						r = ParseText(_ctx, SymbolType_Primary_3, p);
					}
				}
			}
		}
	...
	bool Parse_Sequence(Context& _ctx, const char*& p)
	{
		...
		{
			const char* b = p;
			r = ParseText(_ctx, SymbolType_Item, p);
			if (!r)
			{
				p = b;
				break;
	...
	bool Traverse_CLASS(Context& _ctx, const char*& p, vector<Symbol>& v)
	{
		...
		if (r)
		{
			...
			if (r)
			{
				r = TraverseText(_ctx, SymbolType_CLASS_1, p, v);
			}
		}
		return r;
	}
	...
	bool Traverse_Expression(Context& _ctx, const char*& p, vector<Symbol>& v)
	{
		...
		if (r)
		{
			for (;;)
			{
				const char* b = p;
				size_t s = v.size();
				r = TraverseText(_ctx, SymbolType_Expression_1, p, v);
				if (r)
				{
					r = Visit(_ctx, SymbolType_Sequence, p, v);
				}
	...
	{
		bool r = true;
		r = TraverseText(_ctx, SymbolType_Grammar_1, p, v);
		if (r)
		{
	...
	bool Traverse_IDENTIFIER(Context& _ctx, const char*& p, vector<Symbol>& v)
	{
		...
		if (r)
		{
			r = TraverseText(_ctx, SymbolType_IDENTIFIER_1, p, v);
		}
		return r;
	}
	...
	{
		bool r = true;
		r = TraverseText(_ctx, SymbolType_Item_1, p, v);
		if (r)
		{
			r = Visit(_ctx, SymbolType_Primary, p, v);
			if (r)
			{
				r = TraverseText(_ctx, SymbolType_Item_2, p, v);
			}
		}
		return r;
	}
	...
	bool Traverse_LITERAL(Context& _ctx, const char*& p, vector<Symbol>& v)
	{
		...
		if (r)
		{
			r = TraverseText(_ctx, SymbolType_LITERAL_1, p, v);
		}
		return r;
	}
	...
	bool Traverse_Primary(Context& _ctx, const char*& p, vector<Symbol>& v)
	{
		...
		if (!r)
		{
			p = b;
			v.erase(v.begin() + s, v.end());
			r = TraverseText(_ctx, SymbolType_Primary_1, p, v);
			if (r)
			{
				r = Visit(_ctx, SymbolType_Expression, p, v);
				if (r)
				{
					r = TraverseText(_ctx, SymbolType_Primary_2, p, v);
				}
			}
			if (!r)
			{
				...
				if (!r)
				{
					...
					if (!r)
					{
						p = b;
						v.erase(v.begin() + s, v.end());
						r = TraverseText(_ctx, SymbolType_Primary_3, p, v);
					}
				}
			}
		}
