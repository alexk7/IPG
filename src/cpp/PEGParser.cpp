// This file was automatically generated by IPG on Fri Sep  2 13:32:15 2011
...
namespace
{
	...
	bool TraverseSymbol(Context& _ctx, SymbolType _type, const char*& p, vector<Symbol>& v)
	{
		switch (_type)
		{
			case SymbolType_CLASS: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_CLASS, p, v);
			case SymbolType_CLASS_1: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_CLASS_1, p, v);
			case SymbolType_Char: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_Char, p, v);
			case SymbolType_Definition: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_Definition, p, v);
			case SymbolType_Expression: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_Expression, p, v);
			case SymbolType_Expression_1: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_Expression_1, p, v);
			case SymbolType_Grammar: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_Grammar, p, v);
			case SymbolType_Grammar_1: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_Grammar_1, p, v);
			case SymbolType_IDENTIFIER_1: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_IDENTIFIER_1, p, v);
			case SymbolType_Identifier: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_Identifier, p, v);
			case SymbolType_Item: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_Item, p, v);
			case SymbolType_Item_1: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_Item_1, p, v);
			case SymbolType_Item_2: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_Item_2, p, v);
			case SymbolType_LEFTARROW: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_LEFTARROW, p, v);
			case SymbolType_LITERAL: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_LITERAL, p, v);
			case SymbolType_LITERAL_1: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_LITERAL_1, p, v);
			case SymbolType_Primary: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_Primary, p, v);
			case SymbolType_Primary_1: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_Primary_1, p, v);
			case SymbolType_Primary_2: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_Primary_2, p, v);
			case SymbolType_Primary_3: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_Primary_3, p, v);
			case SymbolType_Range: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_Range, p, v);
			case SymbolType_Sequence: return TraverseMemoized(_ctx, _ctx.memos[_type], Traverse_Sequence, p, v);
			default:
				assert(false);
				return false;
		}
